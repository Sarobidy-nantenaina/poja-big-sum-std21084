package com.nantenaina.base.unit;
...
import com.nantenaina.base.endpoint.event.EventConsumer;
import com.nantenaina.base.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.nantenaina.base.endpoint.event.gen.UuidCreated", payload);
